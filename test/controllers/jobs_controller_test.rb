...
class JobsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should display job applications list" do
    ...
    assert_select ".card-job", count: 3 # Should display 3 job cards
  end
  ...
  test "should show job statistics" do
    ...
    assert_select "p", text: I18n.t("job_applications.total_applications")

    assert_select "#total_applications_count", "24" # Total applications count
  end
